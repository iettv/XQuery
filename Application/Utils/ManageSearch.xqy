...
declare function VideoSearch($SkipChannel as item(), $TextToSearch as xs:string, $TermToSearch as xs:string, $PageLength as xs:integer, $StartPage as xs:integer, $SortBy as xs:string, $Transcript as xs:string) as item()
{
	...
	let $SearchOption := <options xmlns="http://marklogic.com/appservices/search">
							...
							then
							let $FilterSpeaker := substring-after($TextToSearch, 'author:')
							return
		                     <additional-query>{
                                                    cts:or-query((
                                                        cts:element-word-query(xs:QName("Surname"),$FilterSpeaker,("wildcarded","case-insensitive","stemmed","diacritic-insensitive","punctuation-insensitive")),
                                                        cts:element-word-query(xs:QName("Given-Name"),$FilterSpeaker,("wildcarded","case-insensitive","stemmed","diacritic-insensitive","punctuation-insensitive"))
                                    ))
                                     }
                              </additional-query>
							...
							return
                                ...
                                <additional-query>{
                                    cts:or-query((
                                    cts:element-word-query(xs:QName("Surname"),$TextToSearch,("wildcarded","case-insensitive","stemmed","diacritic-insensitive","punctuation-insensitive"), 2),
                                    cts:element-word-query(xs:QName("Given-Name"),$TextToSearch,("wildcarded","case-insensitive","stemmed","diacritic-insensitive","punctuation-insensitive"), 4),
