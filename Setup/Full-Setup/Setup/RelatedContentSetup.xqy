...
let $DBNAME := "IETTV-RelatedContent"
let $DBFORESTNAME := "IETTV-Forest-RelatedContent"
let $MODULESDBNAME := "IETTV-Modules-RelatedContent"
let $MODULESFORESTNAME := "IETTV-Code-RelatedContent"
let $SECURITY_DBNAME := "Security"
let $SCHEMA_DBNAME := "Schemas"
let $XDBCPort := 6501
let $WebDavPort := 6502
let $HttpPort := 6503
let $XDBCService := "IETTV-XDBC-RelatedContent"
let $WebDavService := "IETTV-WEBDAV-RelatedContent"
let $HttpService := "IETTV-HTTP-RelatedContent"
...
let $task-root 	:= "/"
let $task-database:= "IETTV-RelatedContent"
let $task-modules := "IETTV-Modules-RelatedContent"
let $task-user 	:= "admin"
let $config  		:= admin:get-configuration()
