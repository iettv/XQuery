...
let $FetchSubscriptionType := if($GetMasterXML//PricingDetails/@type/string()!='') then ($GetMasterXML//PricingDetails/@type/string()) else ()
...
if ($i//Action/AdditionalInfo/NameValue[matches(Name,'SubscriptionType')]/Value[.=''])
